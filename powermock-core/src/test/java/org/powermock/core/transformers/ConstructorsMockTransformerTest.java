...
public class ConstructorsMockTransformerTest extends AbstractBaseMockTransformerTest {
    ...
    public static Iterable<Object[]> data() {
        return MockTransformerTestHelper.createTransformerTestData(
            ConstructorsMockTransformer.class
        );
    }
    
    public ConstructorsMockTransformerTest(final TransformStrategy strategy, final MockTransformerChain mockTransformerChain) {
        super(strategy, mockTransformerChain);
    }
    
    @Test
    public void should_make_all_constructor_public_if_strategy_is_classloader() throws ClassNotFoundException {
    ...
    @Test
    public void should_leave_constructor_unchanged_if_strategy_is_not_classloader() throws ClassNotFoundException {
