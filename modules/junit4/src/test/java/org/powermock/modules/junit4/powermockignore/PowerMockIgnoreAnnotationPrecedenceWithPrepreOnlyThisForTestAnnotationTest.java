...
/**
 * Verifies the that the {@link PrepareOnlyThisForTest} annotation has
 * precedence over the {@link PowerMockIgnore} annotation.
 * 
 */
@RunWith(PowerMockRunner.class)
@PrepareOnlyThisForTest(ExpectNewDemo.class)
@PowerMockIgnore("samples.expectnew")
public class PowerMockIgnoreAnnotationPrecedenceWithPrepreOnlyThisForTestAnnotationTest {
